...
const Index = () => {
  return <div className="flex flex-col space-y-0">
      <Helmet>
        ...
        <meta name="description" content="Entreprise familiale spécialisée en plâtrerie, peinture et isolation à Port (01). Plus de 25 ans d'expertise, artisans qualifiés, entreprise certifiée RGE. Devis gratuit pour vos travaux de rénovation et construction neuve." />
      ...
      <section className="py-8 bg-[#f7efe8]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map(service => <Link key={service.title} to={service.link} className="group bg-[#f1f1f1] rounded-lg shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden" style={{
            borderTop: `4px solid ${service.iconColor}`
          }}>
                <div className="p-6">
                  <div className="mb-4">
