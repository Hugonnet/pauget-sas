  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Spécialiste isolation thermique par l'extérieur à Port (01). Solutions ITE performantes, entreprise certifiée RGE. Rénovation énergétique globale, devis gratuit pour vos travaux."
        />
...
Nous intervenons dans l'Ain (01) et la Haute-Savoie (74), notamment dans les secteurs de Saint-Julien-en-Genevois, Annemasse, Annecy et leurs environs. Contactez-nous dès aujourd'hui pour un devis personnalisé et gratuit.</p>
            ...
            >
              <img
                src="/lovable-uploads/isolation-exterieure.webp"
